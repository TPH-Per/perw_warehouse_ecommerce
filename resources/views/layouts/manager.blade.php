...
<head>
    ...
    <title>@yield('title', 'Bảng điều khiển Quản lý') - PerW</title>
            ...
            <nav class="col-md-2 d-none d-md-block sidebar">
                ...
                <div class="position-sticky">
                    <ul class="nav flex-column">
                        ...
                        <li class="nav-item">
                            <a class="nav-link {{ request()->routeIs('manager.sales.*') ? 'active' : '' }}"
                               href="{{ route('manager.sales.index') }}">
                        ...
                        <li class="nav-item">
                            <a class="nav-link {{ request()->routeIs('manager.inventory.*') ? 'active' : '' }}"
