...
<div class="page-header">
    <div>
        <h1><i class="bi bi-cart-check"></i> Orders Management</h1>
        <p class="text-muted mb-0">Manage customer orders and shipments</p>
    </div>
</div>
...
<div class="card">
    <div class="card-header d-flex justify-content-between align-items-center">
        <span><i class="bi bi-list"></i> Orders List ({{ $orders->total() }} total)</span>
                    ...
                    <tr>
                        ...
                        <td>
                            <div class="btn-group btn-group-sm">
                                ...
                                <button type="button" class="btn btn-primary" title="Update Status"
