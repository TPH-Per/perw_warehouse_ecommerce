<?php $__env->startSection('title', 'Bảng điều khiển Quản lý'); ?>
...
<div class="row">
    <div class="col-xl-3 col-md-6">
        <div class="stat-card">
            ...
            <h5>Tổng kho hàng</h5>
            <div class="value"><?php echo e(number_format($stats['total_inventory_items'])); ?></div>
    ...
    <div class="col-xl-3 col-md-6">
        <div class="stat-card">
            ...
            <h5>Hết hàng</h5>
            <div class="value text-warning"><?php echo e($stats['low_stock_items']); ?></div>
    ...
    <div class="col-xl-3 col-md-6">
        <div class="stat-card">
            ...
            <div class="value"><?php echo e($stats['today_sales']); ?></div>
        ...
        <div class="card">
            ...
            <div class="card-body">
                <div class="d-flex gap-3">
                    ...
                    <a href="<?php echo e(route('manager.inventory.index')); ?>" class="btn btn-secondary btn-lg">
                        <i class="bi bi-boxes"></i> Quản lý kho hàng
                    </a>
                    <a href="<?php echo e(route('manager.inventory.transactions')); ?>" class="btn btn-success btn-lg">
                        <i class="bi bi-arrow-repeat"></i> Xuất Nhập Kho
                    </a>
                    <a href="<?php echo e(route('manager.inventory.low-stock')); ?>" class="btn btn-warning btn-lg">
                        <i class="bi bi-exclamation-triangle"></i> Xem hàng sắp hết
                    </a>
                    <a href="<?php echo e(route('manager.products.index')); ?>" class="btn btn-info btn-lg">
...
<?php echo $__env->make('layouts.manager', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\temp\perw-project\resources\views/manager/dashboard.blade.php ENDPATH**/ ?>